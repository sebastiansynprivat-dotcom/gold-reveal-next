...
interface AuthContextType {
  ...
  user: User | null;
  loading: boolean;
  signUp: (email: string, password: string, metadata?: { group_name?: string; name?: string; language?: string }) => Promise<{ error: any }>;
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const signUp = async (email: string, password: string, metadata?: { group_name?: string; name?: string; language?: string }) => {

  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { setOpen(v); if (!v) resetForm(); }}>
      <DialogTrigger asChild>
        <button className="w-full rounded-xl border border-border/50 bg-secondary/30 px-4 py-3 hover:border-accent/50 hover:bg-secondary/50 active:scale-[0.98] transition-all cursor-pointer group">

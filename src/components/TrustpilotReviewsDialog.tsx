...
interface TrustpilotReviewsDialogProps {
  children: ReactNode;
}

export default function TrustpilotReviewsDialog({ children }: TrustpilotReviewsDialogProps) {
  return (
    <Dialog>
      ...
      <DialogContent className="glass-card border-accent/20 sm:max-w-xl max-h-[85vh] overflow-y-auto shadow-[0_0_30px_-5px_hsl(var(--accent)/0.15),0_0_60px_-10px_hsl(var(--accent)/0.08)]">
        <DialogHeader className="pr-6">
          <DialogTitle className="text-foreground text-sm">Trustpilot Bewertungen</DialogTitle>
          <DialogDescription className="text-muted-foreground text-xs">Das sagen unsere Chatter über die Zusammenarbeit.</DialogDescription>
        </DialogHeader>

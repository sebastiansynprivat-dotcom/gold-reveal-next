                        ...
                        <div className="mt-3 border-t border-border/30 pt-3">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0 space-y-2">
                              ...
                              {!ds.done && (
                                <button onClick={() => { navigator.clipboard.writeText(`Hey, könnt ihr mich bitte zum Google Drive hinzufügen? Meine E-Mail: ${user?.email || "[DEINE E-MAIL]"} | Model-Account: ${acc.account_email || "[ACCOUNT E-MAIL]"} – Danke! 🙏`); toast.success("Nachricht kopiert!"); }} className="flex items-center gap-2 w-full rounded-lg border border-border/50 bg-secondary/40 px-3 py-2 hover:border-accent/50 hover:bg-secondary/60 active:scale-[0.98] transition-all cursor-pointer group text-left" title="Klicken zum Kopieren">
